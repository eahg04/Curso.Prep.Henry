...
function mesesDelAño(array) {
  ...
  for (var i = 0; i < array.length; i++) {
    if (
      ...
      arrayMesesEncon.push(array[i]);
    }
  }
  if (arrayMesesEncon.length === 3) {
    return arrayMesesEncon;
  } else {
...
function mayorACien(array) {
  ...
  // Tu código:
  var arrayNumMayoACien = [];
  for (var i = 0; i < array.length; i++) {
    if (array[i] > 100) {
      arrayNumMayoACien.push(array[i]);
    }
  }
  return arrayNumMayoACien;
}
